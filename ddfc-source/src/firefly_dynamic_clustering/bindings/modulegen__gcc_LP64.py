...
def module_init():
    root_module = Module('ns.firefly_dynamic_clustering', cpp_namespace='::ns3')
    return root_module
...
def register_Ns3FireflyClusteringHelper_methods(root_module, cls):
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): ns3::FireflyClusteringHelper::FireflyClusteringHelper(ns3::FireflyClusteringHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::FireflyClusteringHelper const &', 'arg0')])
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): ns3::FireflyClusteringHelper::FireflyClusteringHelper() [constructor]
    cls.add_constructor([])
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): ns3::ApplicationContainer ns3::FireflyClusteringHelper::Install(ns3::NodeContainer nodes) const [member function]
    cls.add_method('Install', 
                   'ns3::ApplicationContainer', 
                   [param('ns3::NodeContainer', 'nodes')], 
                   is_const=True)
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): ns3::ApplicationContainer ns3::FireflyClusteringHelper::Install(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Install', 
                   'ns3::ApplicationContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): ns3::ApplicationContainer ns3::FireflyClusteringHelper::Install(std::string nodeName) const [member function]
    cls.add_method('Install', 
                   'ns3::ApplicationContainer', 
                   [param('std::string', 'nodeName')], 
                   is_const=True)
    ## firefly_dynamic_clustering-helper.h (module 'firefly_dynamic_clustering'): void ns3::FireflyClusteringHelper::SetAttribute(std::string name, ns3::AttributeValue const & value) [member function]
...
def register_Ns3FireflyClustering_methods(root_module, cls):
    ...
    cls.add_method('DoDispose', 
                   ...
                   [], 
                   visibility='private', is_virtual=True)
    ## firefly_dynamic_clustering.h (module 'firefly_dynamic_clustering'): void ns3::FireflyClustering::StartApplication() [member function]
    cls.add_method('StartApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## firefly_dynamic_clustering.h (module 'firefly_dynamic_clustering'): void ns3::FireflyClustering::StopApplication() [member function]
    cls.add_method('StopApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
