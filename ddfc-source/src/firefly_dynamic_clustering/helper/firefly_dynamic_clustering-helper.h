...
#ifndef __FIREFLY_DYNAMIC_CLUSTERING_HELPER_H__
#define __FIREFLY_DYNAMIC_CLUSTERING_HELPER_H__
 ...
 */
class FireflyClusteringHelper
{
public:

	// add to node reading at time
   static void addReading(Ptr<Node>,double,double);
   ...
   */
	FireflyClusteringHelper (/*Ipv4Address remote*/);
